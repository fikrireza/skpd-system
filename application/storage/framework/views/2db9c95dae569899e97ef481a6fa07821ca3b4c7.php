...
<html>
  ...
  <body class="hold-transition skin-white layout-top-nav">
    <div class="wrapper">
      ...
      <?php echo $__env->make('includes.navbarumum', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
      ...
      <div class="content-wrapper custombackground">
        <div class="container">
          ...
          <section class="content">
            ...
            <?php if(Session::has('messageloginfailed')): ?>
              <div class="alert alert-danger alert-dismissable">
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                <h4><i class="icon fa fa-ban"></i> Login Gagal!</h4>
                <?php echo e(Session::get('messageloginfailed')); ?>
                ...
                <div class="box-body">
                  <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                      <div class="item">
                        <img src="<?php echo e(asset('images/slider2.png')); ?>" alt="First slide">
                        <?php /* <div class="carousel-caption">
                          Judul : Cara Pengaduan
                        </div> */ ?>
                      </div>
                      <div class="item active left">
                        <img src="<?php echo e(asset('images/slider3.png')); ?>" alt="Second slide">
                      </div>
                      <div class="item next left">
                        <img src="<?php echo e(asset('images/tatacarapengaduan.png')); ?>" alt="Third slide">
                      </div>
                    </div>
                  ...
                  <div class="tab-content">
                    <div class="active tab-pane" id="login">
                      <div class="login-box-body">
                        <p class="login-box-msg"><img src="<?php echo e(asset('images/logokabtangerang.png')); ?>" alt="SPD" />
                        &nbsp;&nbsp;<b>SIMPEDU</b></p>
                    ...
                    <div class="tab-pane" id="daftar">
                      <div class="register-box-body">
                        <?php /* <p class="login-box-msg"><img src="<?php echo e(asset('images/logokabtangerang.png')); ?>" alt="SPD" />
                        &nbsp;&nbsp;<b>SIMPEDU</b></p> */ ?>
          ...
          <div class="row">
            <div class="col-lg-3 col-md-6 col-xs-12">
              ...
              <div class="small-box bg-teal">
                ...
                <?php /* <a href="<?php echo e(url('lihatpengaduan')); ?>" class="small-box-footer">Lihat Data Selengkapnya <i class="fa fa-arrow-circle-right"></i></a> */ ?>
              </div>
            </div><!-- ./col -->
            <div class="col-lg-3 col-md-6 col-xs-12">
              <!-- small box -->
            ...
            <div class="col-lg-3 col-md-6 col-xs-12">
              ...
              <div class="small-box bg-maroon">
                ...
                <?php /* <a href="<?php echo e(url('datawarga')); ?>" class="small-box-footer">Lihat Data Selengkapnya <i class="fa fa-arrow-circle-right"></i></a> */ ?>
              </div>
            </div><!-- ./col -->
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="box box-solid">
                <div class="box-header with-border">
                  <img src="<?php echo e(asset('images/logokabtangerang.png')); ?>">
          ...
          <div class="row">
            <section class="col-lg-3 col-md-3 col-xs-12">
              ...
              <div class="box box-primary">
                ...
                <div class="user-block">
                  <img class="img-circle img-bordered-sm" src="<?php echo e(asset('images/stars.png')); ?>" alt="user image">
                  <span class="username">
                      <h4>Kependudukan</h4>
                  </span>
                </div>
                  ...
                  <ul class="products-list product-list-in-box">
                    <li class="item">
                      ...
                      <div class="product-info">
                        ...
                        <a href="<?php echo e(url('detail/pengaduan-warga')); ?>">
                          [Selengkapnya]
                        </a>
                      </div>
                    </li><!-- /.item -->
                ...
                <div class="box-footer text-center">
                  <a href="<?php echo e(url('viewall/topik-aduan')); ?>" class="label uppercase bg-blue">Lihat Semua</a>
                </div><!-- /.box-footer -->
              </div>
            </section>
            ...
            <section class="col-lg-3 col-md-3 col-xs-12">
              <div class="box box-success">
                <div class="box-header with-border">
                  <div class="user-block">
                    <img class="img-circle img-bordered-sm" src="<?php echo e(asset('images/megaphone.png')); ?>" alt="user image">
                    <span class="username">
                ...
                <div class="box-body">
                    <ul class="nav nav-pills nav-stacked">
                      <li>
                        <a href="<?php echo e(url('viewall/topik-aduan')); ?>">
                          Pengaduan Listrik
                        </a>
                      </li>
                      <li>
                ...
                <div class="box-footer text-center">
                  <a href="<?php echo e(url('detail/semua-pengaduan-lainnya')); ?>" class="label uppercase bg-blue">Lihat Semua</a>
                </div><!-- /.box-footer -->
              </div>
            </section>
            <!-- List tidak poluler -->
