            ...
            <div class="row">
              <div class="col-md-9">
                ...
                <div class="box-header with-border">
                  <h3 class="box-title">Detail Pengaduan Warga</h3>
                </div>
                <div class="box-body">
                  ...
                  <div class="post">
                    <div class="user-block">
                      ...
                      <span class='description'>
                        Pelapor : Amanda Satyarini
                      </span>
                      <span class='description' style="padding-top:3px;">
                    ...
                    <div class='box-footer box-comments' style="border:1px solid #00a65a;margin-top:5px;">
